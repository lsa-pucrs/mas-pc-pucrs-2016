...
closestFacility(List, Facility) :- roled(Role, _, _, _, _) & pucrs.agentcontest2015.teamB.actions.closest(Role, List, Facility).
closestFacility(List, Facility, RouteLen) :- roled(Role, _, _, _, _) & pucrs.agentcontest2015.teamB.actions.closest(Role, List, Facility, RouteLen).
