...
package pucrs.agentcontest2015.teamB.cnp;
...
public class TaskBoard extends Artifact {
	...
	@OPERATION void announce(String taskDescr, int duration, OpFeedbackParam<String> id){
		...
		try {
			...
			makeArtifact(artifactName, "pucrs.agentcontest2015.teamB.cnp.ContractNetBoard", new ArtifactConfig(taskDescr,duration));
