...
<-
	...
	pucrs.agentcontest2016.teamB.actions.tolower(Role, File);
	.concat(File, ".asl", FileExt);
	pucrs.agentcontest2016.teamB.actions.include(FileExt);
	if (Role == "Truck")
	{
		pucrs.agentcontest2016.teamB.actions.include("initiator.asl");
		!create_taskboard;
	};
